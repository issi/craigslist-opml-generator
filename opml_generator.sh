...
for s in $STATES; do
  echo "    <outline text=\"Craigslist $s\" title=\"Craigslist $s\" type=\"rss\" xmlUrl=\"https://$s.craigslist.org/search/mca?format=rss\" htmlUrl=\"https://$s.craigslist.org/search/mca\" />"
done
echo '    </outline>'
echo '  </body>'
echo '</opml>'
